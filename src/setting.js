let globalSettings = {
  ...
  copyrightDates: "2021",
  copyrightCompany: "vue-iview-admin-template",
  copyrightWebsite: "https://github.com/dao-projects/vue-iview-admin-template",
  // 是否开启导航搜索
...
if (process.env.ENV === "staging" || process.env.NODE_ENV === "development") {
  ...
  globalSettings.enableThemeSetting = true;
}
